...
/**
 * DltSocialResonanceData
 *
 * @author tangxuelong
 */
@Data
@NoArgsConstructor
public class DltSocialResonanceData {
    ...
    private Integer number08;
    private Integer number09;
    ...
    private Integer number32;
    private Integer number33;
    private Integer number34;
    private Integer number35;
    private String remark;
    private Timestamp createTime;
    private Timestamp updateTime;

    public DltSocialResonanceData(String periodId, Integer socialType, Integer resonanceType) {
