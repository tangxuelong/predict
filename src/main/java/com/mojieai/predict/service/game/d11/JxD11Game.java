...
@Component
public class JxD11Game extends D11Game {
    @Override
    public Game getGame() {
        return GameEnum.JXD11.getGame();
    }
    ...
    public Integer getDailyPeriod() {
        return D11GameEnum.JXD11_DAILY_PERIOD;
    }

    @Override
    public Integer getPeriodInterval() {
        return D11GameEnum.JXD11_TIME_INTERVAL;
    }

    @Override
    public String getInitPeriodFormat() {
        return D11GameEnum.JXD11_INIT_PERIOD_FORMAT;
    }
}
