...
@Component
public class SdD11Game extends D11Game {
    @Override
    public Game getGame() {
        return GameEnum.SDD11.getGame();
    }
    ...
    @Override
    public Integer getDailyPeriod() { return D11GameEnum.SDD11_DAILY_PERIOD;};

    @Override
    public Integer getPeriodInterval(){
        return D11GameEnum.SDD11_TIME_INTERVAL;
    }

    @Override
    public String getInitPeriodFormat(){
        return D11GameEnum.SDD11_INIT_PERIOD_FORMAT;
    }
}
