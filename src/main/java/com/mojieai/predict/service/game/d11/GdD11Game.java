...
@Component
public class GdD11Game extends D11Game {
    @Override
    public Game getGame() {
        return GameEnum.GDD11.getGame();
    }
    ...
    public Integer getDailyPeriod() {
        return D11GameEnum.GDD11_DAILY_PERIOD;
    }

    @Override
    public Integer getPeriodInterval() {
        return D11GameEnum.GDD11_TIME_INTERVAL;
    }

    @Override
    public String getInitPeriodFormat() {
        return D11GameEnum.GDD11_INIT_PERIOD_FORMAT;
    }
}
