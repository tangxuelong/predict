...
public class DateUtil {
    ...
    public static final int FMT_DATE_YYYY_MM_DD_HH_MM = 21;
    /**
    ...
    public static Timestamp parseUtilDate(String strDate, int nFmtDate) {
        ...
        switch (nFmtDate) {
            ...
            case DateUtil.FMT_DATE_YYYYMMDDHHMM:
                ...
                break;
            case DateUtil.FMT_DATE_YYYY_MM_DD_HH_MM:
                fmtDate = new SimpleDateFormat("MM-dd HH:mm");
                break;
        }
        try {
...
//                DateUtil.DATE_FORMAT_YYYYMMDDHH));
    ...
    public static Timestamp getBeginOfNextMonth() {
        String firstDayOfCurrentMonth = getNextMonth() + "01";
        return formatString(firstDayOfCurrentMonth, FMT_DATE_SPECIAL);
    }
...
//		System.err.println("dayOfWeek:" + dayOfWeek + ",diffdays：" + diffdays);
    ...
    //大盘彩开奖公告时间   格式:    2017年2月21日(周二)
    public static String getCommonGameAwardTime(Timestamp target) {
        String time = formatTime(target, DATE_FORMAT_Y_M_D);
