...
public class IdCardUtils {
    public final static Pattern PARTTERN_CARD_NO = Pattern.compile("\\d{15}|\\d{17}[0-9X]");
    public final static Pattern PARTTERN_DATE = Pattern.compile(
    ...
    // 1-17位相乘因子数组
    public final static int[] FACTOR = {7, 9, 10, 5, 8, 4, 2, 1, 6, 3, 7, 9, 10, 5, 8, 4, 2};
    // 18位随机码数组
    public final static char[] RANDOM = "10X98765432".toCharArray();
