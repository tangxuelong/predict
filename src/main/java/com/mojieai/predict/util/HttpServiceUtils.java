...
import com.mojieai.predict.exception.RemoteInvocationFailureException;
...
public class HttpServiceUtils {
    ...
    public static String sendRequest(String url, int connectTimeout, int readTimeout, String charset, boolean
        ...
        try {
            ...
            conn = getURLConnection(url, connectTimeout, readTimeout, false);
    ...
    public static String sendPostRequest(String url, String content, String charset, int connectTimeout, int
            readTimeout, boolean needCompress, String contentType, boolean returnSingle, boolean useAgent)
            throws RemoteInvocationFailureException {
        BufferedReader in = null;
        HttpURLConnection httpConn = null;
        try {
            httpConn = getURLConnection(url, connectTimeout, readTimeout,
                    contentType, useAgent);
            if (StringUtils.isBlank(charset)) {
                charset = HttpParamDto.DEFAULT_CHARSET;
            }
    ...
    public static String sendPostRequest(String url, String content, String charset, int connectTimeout, int
            readTimeout, String contentType, Boolean useAgent)
            throws RemoteInvocationFailureException {
        return sendPostRequest(url, content, charset, connectTimeout,
                readTimeout, false, contentType, false, useAgent);
    }
    ...
    public static String sendPostRequest(String url, String content, String charset,
            ...
            throws RemoteInvocationFailureException {
        return sendPostRequest(url, content, charset, connectTimeout,
                readTimeout, needCompress, null, false, false);
    }
     ...
     */
    public static String sendPostRequest(String url, String content, String charset, int connectTimeout, int
            readTimeout, boolean needCompress, SSLContext sslContext, Boolean useAgent) throws MalformedURLException,
            IOException {
        InputStream is = null;
        // BufferedReader in = null;
        HttpURLConnection httpConn = null;
        ...
        charset = StringUtils.isBlank(charset) ? HttpParamDto.DEFAULT_CHARSET
                : charset;
        try {
            httpConn = getURLConnection(url, connectTimeout, readTimeout, null, useAgent);
            if (StringUtils.isBlank(charset)) {
                charset = HttpParamDto.DEFAULT_CHARSET;
            }
    ...
    public static String sendHttpsPostRequest(String url, String content, String charset, int connectTimeout, int
            readTimeout, boolean needCompress, String contentType, boolean returnSingle, Boolean useAgent)
            throws RemoteInvocationFailureException {
        BufferedReader in = null;
    ...
    public static String sendHttpsPostRequest(String url, String content, String charset) {
        return sendHttpsPostRequest(url, content, null, charset, false);
    }

    public static String sendHttpsPostRequest(String url, String content, String contentType, String charset, Boolean
            useAgent) {
        return sendHttpsPostRequest(url, content, charset,
                HttpParamDto.DEFAULT_CONNECT_TIME_OUT,
                HttpParamDto.DEFAULT_READ_TIME_OUT, false, contentType, false, useAgent);
    }

    public static String sendHttpPostRequestAndSetHeader(String url, Map<String, String> header, String content, String
            charset) {
        ...
        String contentType = "";
        try {
            httpConn = getURLConnection(url, header, HttpParamDto.DEFAULT_CONNECT_TIME_OUT, HttpParamDto
                    .DEFAULT_READ_TIME_OUT);
            if (StringUtils.isBlank(charset)) {
                charset = HttpParamDto.DEFAULT_CHARSET;
            }
            InputStream stream = postConnect(httpConn, content, charset, false);
     ...
     * @throws RemoteInvocationFailureException
     */
    private static HttpsURLConnection getHttpsURLConnection(String urlStr, int connectTimeout, int readTimeout,
                                                            String contentType, Boolean useAgent)
            throws RemoteInvocationFailureException {
        try {
            URL remoteUrl = new URL(urlStr);
    ...
    private static HttpURLConnection getURLConnection(String urlStr, int connectTimeout, int readTimeout, Boolean
            useAgent)
            throws RemoteInvocationFailureException {
        return getURLConnection(urlStr, connectTimeout, readTimeout, null, useAgent);
    }

    /**
     * 设置http的header
     */
    private static HttpURLConnection getURLConnection(String urlStr, Map<String, String> header, int connectTimeout,
                                                      int readTimeout) {
        try {
            URL remoteUrl = new URL(urlStr);
            HttpURLConnection httpConn = (HttpURLConnection) remoteUrl
...
//                log.debug("从中心返回：" + result);
    ...
    public static String getRequestFileStr(String urlStr) {
        ...
        try {
            ...
            conn = getURLConnection(urlStr, HttpParamDto.DEFAULT_CONNECT_TIME_OUT, HttpParamDto
