...
import com.mojieai.predict.util.JDPay.RsaUtil;
import com.mojieai.predict.util.JDPay.VerifySignatureUtl;
...
public class XmlEncryptUtil {
    ...
    public static String encrypt(String rsaPrivateKey, String strDesKey, String genSignStr) {
        ...
        if (StringUtils.isNotEmpty(rsaPrivateKey) && StringUtils.isNotEmpty(strDesKey) && StringUtils.isNotEmpty(genSignStr)) {
            try {
                ...
                encrypt = org.apache.commons.codec.binary.Base64.encodeBase64String(ThreeDes1Util.encrypt2HexStr(RsaUtil.decryptBASE64(strDesKey), data).getBytes("UTF-8"));
    ...
    public static String decrypt(String rsaPubKey, String strDesKey, String encrypt) {
        ...
        try {
            reqBody = ThreeDes1Util.decrypt4HexStr(RsaUtil.decryptBASE64(strDesKey), new String(Base64.decodeBase64(encrypt), "UTF-8"));
