...
public enum DltKillNumAchievementEnumNew implements SocialAchievement {
    ...
    DltKillNumAchievementEnumNew(String name, Integer type, Integer socialCount, Integer rightCount) {
        this.name = name;
        this.type = type;
    ...
    public static String getNameByType(Integer type) {
        for (DltKillNumAchievementEnumNew killAchieve : DltKillNumAchievementEnumNew.values()) {
