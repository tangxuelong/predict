...
public enum DltChartEnum implements ChartEnumInterface {
    AWARD(0, "AWARD") {
        @Override
        ...
        public Map<String, Object> generateChart(Long gameId, String periodId, TrendDao trendDao) {
            return TrendUtil.generateChart(gameId, periodId, new String[]{TrendConstant.KEY_TREND_FRONT_AREA,
                    TrendConstant.KEY_TREND_BACK_AREA});
        }
        ...
        public TrendEnumInterface getTrendEnum() {
            return DltTrendEnum.FRONT;
        }

        @Override
        public Map<String, Object> generateChart(Long gameId, String periodId, TrendDao trendDao) {
            return TrendUtil.generateChart(gameId, periodId, FRONT, trendDao);
        }
        ...
        @Override
        public TrendEnumInterface getTrendEnum() {
            return DltTrendEnum.BACK;
        }

        @Override
        public Map<String, Object> generateChart(Long gameId, String periodId, TrendDao trendDao) {
            return TrendUtil.generateChart(gameId, periodId, BACK, trendDao);
        }
    ...
    }, FRONT_COLD_HOT(3, "FRONT_COLD_HOT") {
        @Override
        public ChartEnum getChartEnum() {
        ...
        @Override
        public TrendEnumInterface getTrendEnum() {
            return DltTrendEnum.LEADING_BALL;
        }
        ...
        @Override
        public TrendEnumInterface getTrendEnum() {
            return DltTrendEnum.SWALLOW_TAIL;
        }
        ...
        @Override
        public TrendEnumInterface getTrendEnum() {
            return DltTrendEnum.ZERO_ONE_TWO_WAY;
        }
        ...
        @Override
        public TrendEnumInterface getTrendEnum() {
            return DltTrendEnum.SPAN_VALUE;
        }
    ...
    DltChartEnum(int chartType, String chartName) {
        this.chartType = chartType;
        this.chartName = chartName;
    }

    public static DltChartEnum getByChartType(int chartType) {
        for (DltChartEnum k : DltChartEnum.values()) {
